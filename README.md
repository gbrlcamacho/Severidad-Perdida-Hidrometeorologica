...
> ⚠️ **Completa estos valores con los que imprime tu script en la consola**
> (líneas finales: "Costo promedio esperado por evento en 2024/2025").
...
1. Instala los paquetes listados arriba.
2. Abre y ejecuta [`R/proyecto_severidad.R`](R/proyecto_severidad.R) en RStudio.
   Los datos se descargan automáticamente del Atlas Nacional de Riesgos (requiere
   internet).
3. (Opcional) Para regenerar las imágenes del README, ejecuta después
   [`R/guardar_figuras.R`](R/guardar_figuras.R).
